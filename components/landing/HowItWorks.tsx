...
export function HowItWorks() {
  ...
  return (
    <section id="how-it-works" className="py-10 sm:py-16 md:py-24 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <motion.div
          ...
          className="mb-6 sm:mb-12 md:mb-20 text-center"
        >
          <h2 className="font-accent text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight mb-3 sm:mb-4 text-text">
            Get started in minutes
          </h2>
        </motion.div>

        <div className="relative grid grid-cols-1 md:grid-cols-4 gap-6 sm:gap-8 md:gap-12">
